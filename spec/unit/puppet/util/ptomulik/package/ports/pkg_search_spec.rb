...
describe Puppet::Util::PTomulik::Package::Ports::PkgSearch do
  let(:test_class) do
    Class.new do
      extend Puppet::Util::PTomulik::Package::Ports::PkgSearch
  ...
  PkgRecord = Puppet::Util::PTomulik::Package::Ports::PkgRecord

...
describe Puppet::Util::PTomulik::Package::Ports::PortSearch do
  let(:test_class) do
    Class.new do
      extend Puppet::Util::PTomulik::Package::Ports::PortSearch
    ...
    [
      ...
      [
        ...
        [
          [
            'www/apache22',
            Puppet::Util::PTomulik::Package::Ports::PortRecord[{
              :portorigin => 'www/apache22',
            }]
          ]
        ],
